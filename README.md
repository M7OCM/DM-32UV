...
It should be noted that the CPS is extremely buggy, even the latest, and the various firmware revisions are too, some features do not work but most do on the official release 046 (latest Baofeng 'test' firmware is 048 and CPS 1.45, use with caution, record function removed, however CSV contacts have increased from 50K to 150K). These are provided here purely as a one stop archive. The validity of the content is for the most part unknown; 046/048 are Baofeng. There are many firmware versions I have not discovered and I am interested in hearing from anyone that can share early test firmware or CPS not listed herein.
